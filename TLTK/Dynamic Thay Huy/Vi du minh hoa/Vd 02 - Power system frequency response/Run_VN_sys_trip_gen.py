...
# Code:       Nguyen Duc Huy
# Date: 
# Purpose:    Observe the system frequency and primary responses with 
#             N-1 generation event 
# ===================================================================================
...
outfile    = os.path.join(casedir,'VN_freq_N1.out')
...
ier                 = chsb(4,0,[-1,-1,-1,1,13,0])       # Voltage
# ier                 = chsb(0,1,[-1,-1,-1,1,3,0])        # Qvar
# ier                 = chsb(4,0,[-1,-1,-1,1,2,0])        # Pelec
ier                 = strt(1,outfile)
...
stop_2()
##
###ier             = dist_bus_fault(BUSID,1,220.0,[0.0,-0.2E+10])
###ier             = run (0,15.1,5000,10,1)
###ier             = dist_clear_fault(1)
##ier              = run(0, 50,5000,10,1)
###
