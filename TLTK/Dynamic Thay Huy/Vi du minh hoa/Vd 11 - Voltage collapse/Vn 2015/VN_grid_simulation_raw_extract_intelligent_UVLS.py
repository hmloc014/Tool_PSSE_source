...
##=========================================================
#
##rawfile     = os.path.join(casedir,'vn2011_220.raw')
...
##    ierr            = psspy.dynamicsmode(0)
    if t2 == 145:
        for ii in range(0,nload):
            iers        = psspy.load_chng_4(i = lbus[ii], id = r'1', realar = [mvalod[ii].real*0.97,
                                                                               mvalod[ii].imag*0.97,
                                                                               ilod[ii].real*0.97,
                                                                               ilod[ii].imag*0.97,
                                                                               ylod[ii].real*0.97,
...
# Angle
ierr, ang       = psspy.abusreal(-1, 2, ['angled'])
ang             = ang[0]
# Voltage
ierr, volt      = psspy.abusreal(-1, 2, ['pu'])
volt            = volt[0]
