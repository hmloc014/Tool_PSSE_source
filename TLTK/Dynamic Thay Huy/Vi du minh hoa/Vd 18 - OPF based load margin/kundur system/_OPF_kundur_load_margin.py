...
# ============================================================================================
buses       = range(1,13)
genbus      = [3,4,1,2] # Try 1,2 and 3,4 separately
...
##two_winding_chng_4(1,5, r"""1""",intgar7 = 17,intgar12 = 1)
##two_winding_chng_4(2,6, r"""1""",intgar7 = 17,intgar12 = 1)
##two_winding_chng_4(3,11,r"""1""",intgar7 = 17,intgar12 = 1)
##two_winding_chng_4(4,10,r"""1""",intgar7 = 17,intgar12 = 1)
...
for ii in range(0,ngenbus):
    ...
    ert     = opf_apdsp_tbl(tbl = idx,intgar = [2,1,idx],realar = [1900,50,1])
    erg     = opf_gendsp_indv(genbus[ii-1],r"""1""",idx,1)
    print erg
...
TargetBUS   = 7
idx         += 1
er1         = opf_csttbl_lin(idx,r"LOAD",2,[0.0,0.0, 4000.0, 900000])
er2         = opf_adjload_tbl(idx,[1,_i,0],[1,9.5,0.2, 1.0, 1.0, 1.0, 100])
...
Pl          = Pl[0]
lbus        = lbus[0]
er,Ptie     = brnflo(7,8,r'1')
print 'Cong suat trao doi', Ptie
