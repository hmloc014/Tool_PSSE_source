...
class SimpleGrid(gridlib.Grid): ##, mixins.GridAutoEditMixin):
    def __init__(self, parent, log):
        ...
        # self.SetCellBackgroundColour(2, 2, wx.CYAN) wx.Colour( 131, 196, 235 )
        self.SetReadOnly(3, 3, True)

        self.SetCellBackgroundColour(2, 2, wx.Colour( 255, 255, 255 )) 
        self.SetCellBackgroundColour(3, 2, wx.Colour( 131, 196, 235 )) 
        self.SetCellBackgroundColour(4, 2, wx.Colour( 131, 196, 235 )) 
        self.SetCellBackgroundColour(5, 2, wx.Colour( 131, 196, 235 )) 
    ...
    def OnCellChange(self, evt):
        ...
        color = self.GetCellTextColour(1, 1)
        print('----------------color is:',color)
        if color == wx.Colour(255, 0, 0, 255):
            print('yeap--------')
